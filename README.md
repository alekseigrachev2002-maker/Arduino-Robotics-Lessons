...
Для успешного прохождения этого курса ученики должны знать базовые принципы работы с Arduino. Если вы забыли, как подключать светодиоды, кнопки или сервоприводы, вы можете освежить знания здесь:
👉 **[Скачать методичку за 8 класс (PDF)](./docs/arduino_course_grade8.pdf)**
