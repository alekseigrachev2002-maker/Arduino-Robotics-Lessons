...
Прежде чем собирать схему, нужно разобраться, откуда робот берет энергию. **Модуль питания** получает энергию от двух мощных аккумуляторов Li-ion (напряжение 7.4 – 8.4 Вольта) и безопасно распределяет её по роботу.
...
2. **Для силовой части (моторы)** нужно большая мощность, то есть высокий ток. При старте или под нагрузкой моторы создают сильные помехи и забирают много энергии. 
...
- На самом деле функция управляет мощностью, которая подается на мотор. Чем выше мощность, тем быстрее крутятся моторы.
